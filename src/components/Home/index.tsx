...
const Home = () => {
  return (
    <div
      ...
      style={{
        backgroundColor: '#C4B682'
      }}>
      <div className="mx-auto px-6 lg:px-20 xxl:px-0 relative" style={{ maxWidth: '1100px' }}>
              ...
              <div className="grid place-items-center">
                <div>
                  <div className="flex justify-center lg:justify-start">
                    <h1 className="lg:hidden font-semibold text-center text-3xl sm:text-4xl md:text-5xl leading-tight mb-5">
                      Where Beauty Meets Luxury -<br />
                      <span className="text-white">Sugar&apos;d Bare</span>
                    </h1>
                    <h1 className="hidden lg:block font-semibold text-5xl leading-tight mb-5">
                      Where Beauty <br /> Meets Luxury -<br />
                      <span className="text-white">Sugar&apos;d Bare</span>
                    </h1>
                  </div>
                  <p className="text-left text-sm sm:text-base px-10 sm:px-20 md:px-40 lg:px-0 lg:px-20">
                  ...
                  <div className="grid justify-center pt-12">
                    <a href="#" className="flex">
                      <p className="grid place-items-center text-xs font-semibold text-center underline mr-6">
                        View Services
                      </p>
